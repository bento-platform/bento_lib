...
SECRET_KEY = 'django-insecure-x@qwib$ly@x0hr$dcd1!p9bq@m=_es=8foaa7q*&!r@aysh65i'
...
INSTALLED_APPS = [
    ...
    'tests.django_test_project.test_app.apps.TestAppConfig',
]
...
BENTO_AUTHZ_MIDDLEWARE_CONFIG = {
    "AUTHZ_SERVICE_URL": "https://bento-auth.local",
    "LOGGER": logger,
}
